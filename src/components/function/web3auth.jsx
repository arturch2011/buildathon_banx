    ...
    if (address) {
        return (
            ...
            >
                ...
                {showDrop.drop1 && (
                    <div className="md:absolute md:right-0 md:top-[140%] flex flex-col items-center rounded-xl p-4 bg-gray-700/25 backdrop-blur-xl">
                        <Link
                            href={`/${address}`}
                            className="py-1 px-5 bg-cbrown w-full rounded-xl mb-2 text-center hover:bg-white"
                        >
                            Profile
                        </Link>
                        <button
                            onClick={logout}
                            className="p-1 px-5 bg-cbrown w-full rounded-xl text-center hover:bg-white"
                        >
                            Logout
                        </button>
                    </div>
